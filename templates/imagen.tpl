<!-- BEGIN PAGE HEADER-->
	<div class="page-bar">
	 ...
	 <!-- BEGIN PAGE TITLE-->
		<h1 class="page-title"> Catalogo de imagenes
			<small></small>
		</h1>
	 <!-- END PAGE TITLE-->
<!-- END PAGE HEADER-->
...
<!-- BEGIN PAGE CONTENT-->
	<div class="row">
	    <div class="portlet box green" id="add_new_image" style="display:none;">
	    	{include file="{$DOC_ROOT}/templates/forms/add_image.tpl"}
	    </div>
		<div class="portlet light portlet-fit portlet-datatable bordered">
			<div class="portlet-title">
				<div class="caption">
				   <i class="icon-settings font-green"></i>
				   <span class="caption-subject font-green sbold">Catalogo de imagenes</span>
				 </div>  
				<div class="actions">
